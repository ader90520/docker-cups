...
class ScanHandler(BaseHandler):
    def get(self):
        ...
        try:
            ...
            res = subprocess.run(["scanimage", "-L"], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True, timeout=8)
    ...
    def post(self):
        ...
        try:
            ...
            print(f"[ScanHandler] ✔ 扫描并转换完成: {target_jpg}")
